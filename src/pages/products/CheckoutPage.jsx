      ...
      <div className="max-w-5xl w-full bg-white shadow-lg rounded-lg p-8 border border-[#A67C52]">
        ...
        <div className="bg-[#F5EFE6] rounded-lg shadow-md p-6 mb-6">
          ...
          <p className="text-gray-700">
            {t("checkout.total_price")} <span className="font-bold text-[#A67C52]">${totalPrice}</span>
          </p>
          <p className="text-gray-700">
          ...
          <div className="md:col-span-2 flex flex-col items-center mt-4">
            <div className="flex items-center space-x-2">
              ...
              <label className="text-gray-600">
                {t("checkout.agree")} <Link className="text-[#A67C52] underline">{t("checkout.terms")}</Link> {t("checkout.and")} <Link className="text-[#A67C52] underline">{t("checkout.policy")}</Link>.
              </label>
            </div>
